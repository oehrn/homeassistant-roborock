...
class RoborockSwitch(RoborockEntity, SwitchEntity):
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        await self.entity_description.update_value(
            self.api.cache.get(self.entity_description.cache_key), False
        )

    async def async_turn_on(self, **kwargs: Any) -> None:
        """Turn on the switch."""
        await self.entity_description.update_value(
            self.api.cache.get(self.entity_description.cache_key), True
        )
    ...
    def is_on(self) -> bool | None:
        ...
        return (
            self.api.cache.get(self.entity_description.cache_key).value.get(
